...
public class standupcom extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_standupcom);
    ...
    public void onBackPressed() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainintent = new Intent(standupcom.this, CulturalselectActivity.class);
