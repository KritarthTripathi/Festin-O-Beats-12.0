...
public class Codejam1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private CodeFragmentAdapter codeadapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_codejam1);
        ...
        tabLayout= findViewById(R.id.tabforquiz);
        vp= findViewById(R.id.VP1);



        FragmentManager fragmentManager1= getSupportFragmentManager();
        codeadapter= new CodeFragmentAdapter(fragmentManager1,getLifecycle());
        vp.setAdapter(codeadapter);
    ...
    public void onBackPressed() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainintent = new Intent(Codejam1.this, Techselect.class);
