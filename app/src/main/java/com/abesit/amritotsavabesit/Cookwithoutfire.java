...
public class Cookwithoutfire extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cookwithoutfire);
    ...
    public void onBackPressed() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainintent = new Intent(Cookwithoutfire.this, Fineselect.class);
